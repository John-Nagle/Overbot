...
#define DSC_VERSION  0x0570  /* 0xVVRR - Version & Revision */
...
typedef struct
{
	...
	BYTE addiff;		  /* For HERCULES only, SINGLE_ENDED or DIFFERENTIAL */
...
BYTE DSCUDAPICALL dscPWMClear(DSCB board, BYTE pwmCircuit);
