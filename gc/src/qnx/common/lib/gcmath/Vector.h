 ...
 * $Id: Vector.h,v 1.1 2003/10/26 17:17:27 khianhao Exp $
 *
 * (c) Aaron Kahn
 * (c) Trammell Hudson
 *
...
public:
	...
	/*
 	* Convert a vector into a pointer to its data structure.  Yes, this
 	* violates the basic assumptions about data hiding, but we "feel
 	* the need for speed".
 	*/
	T *
	array()
