...
int
neutral_button_pressed( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	model->shift_button_pressed(MsgSpeedSet::gear_neutral);		// do the work in the model
