...
int
offline_semiauto_selected( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	model->mode_change_selected(Manualdrive::OfflineSemiautoMode);	// do the work in the model
	return( Pt_CONTINUE );
