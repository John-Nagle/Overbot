...
int
high_button_pressed( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	model->shift_button_pressed(MsgSpeedSet::gear_high);		// do the work in the model
