...
int
remote_manual_selected( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	model->mode_change_selected(Manualdrive::RemoteManualMode);	// do the work in the model
	return( Pt_CONTINUE );
