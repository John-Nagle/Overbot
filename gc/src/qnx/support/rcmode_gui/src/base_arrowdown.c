...
/**
 * Called everytime down button pressed in the big click button
 */
int
base_arrowdown( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
